    ...
    return FadeTransition(
      ...
      child: Material(
        ...
        child: GestureDetector(
          ...
          child: Stack(
            children: [
              // Parlayan glow'lu overlay
              ValueListenableBuilder<double>(
                valueListenable: _PulseNotifier(_pulseController),
...
/// Pulse animasyonu için ValueNotifier wrapper
class _PulseNotifier extends ValueNotifier<double> {
  final AnimationController _controller;

  _PulseNotifier(this._controller) : super(_controller.value) {
